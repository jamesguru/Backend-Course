...
const AppointmentEmail = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let appointment of appointments) {
        ejs_1.default.renderFile('templates/Appointment.ejs', { name: appointment.patient_email, date: appointment.date }, (err, data) => __awaiter(void 0, void 0, void 0, function* () {
            let messageoption = {
